...
if (is_in_dir == FALSE) {
  ...
  if (istgleich_geladen_gestern == FALSE) {
    ...
    # Umbenannten Datensatz 'geladen.xlsx', jetzt "RKI_Impfquote_COVID19_",Sys.Date(),".xlsx", laden und in RKI_Impf_heute_blatt_2/3/4 laden
    header_blatt_2 <- c("rs", "bundesland",
                        "gesamtzahl_bisher_verabreichter_impfungen","gesamtzahl_mindestens_einmal_geimpft","gesamtzahl_grundimmunisierter","gesamtzahl_personen_mit_auffrischungsimpfung",
                        
                        "impfquote_mindestens_einmal_geimpft_gesamt","impfquote_mindestens_einmal_geimpft_5-17_jahre_gesamt","impfquote_mindestens_einmal_geimpft_5-17_jahre_5-11_jahre","impfquote_mindestens_einmal_geimpft_5-17_jahre_12-17jahre",
                        "impfquote_mindestens_einmal_geimpft_18+_jahre_gesamt","impfquote_mindestens_einmal_geimpft_18+_jahre_18-59_jahre","impfquote_mindestens_einmal_geimpft_18+_jahre_60+_jahre",
                        
                        "impfquote_grundimmunisiert_gesamt","impfquote_grundimmunisiert_5-17_jahre_gesamt","impfquote_grundimmunisiert_5-17_jahre_5-11_jahre","impfquote_grundimmunisiert_5-17_jahre_12-17jahre",
                        "impfquote_grundimmunisiert_18+_jahre_gesamt","impfquote_grundimmunisiert_18+_jahre_18-59_jahre","impfquote_grundimmunisiert_18+_jahre_60+_jahre",
                        
                        "impfquote_auffrischimpfung_gesamt","impfquote_auffrischimpfung_12-17_jahre",
                        "impfquote_auffrischimpfung_18+_jahre_gesamt","impfquote_auffrischimpfung_18+_jahre_18-59_jahre","impfquote_auffrischimpfung_18+_jahre_60+_jahre")
                        
                        
                        # "impfquote_mindestens_einmal_geimpft_>18_jahre_gesamt","impfquote_mindestens_einmal_geimpft_>18_jahre_18-59_jahre","impfquote_mindestens_einmal_geimpft_>18_jahre_60+_jahre",
