...
if (is_in_dir) {
  ...
  if (any(a) == FALSE) {
    ...
    ### Wenn die Daten neu sind werden sie zum RKI_Impf_gesamt hinzugeüft bzw. es wird noch mal weiter getestet ob sie schon enthalten sind.
    ### Dieser Teil ist weiterhin in der if schleife if (any(a) == FALSE).
