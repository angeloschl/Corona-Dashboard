...
valueBox(glue::glue("{NummernMitPunkt(Neufindektion_heute$Sieben_Tage_Inzidenz,digits = 1)} ({VergleichVortagePfeil(Neufindektion_Datum_df,Sieben_Tage_Inzidenz, Anzahl = 4)})"),
...
```{r}
Städte = c("SK Darmstadt","LK Darmstadt-Dieburg", "SK Frankfurt am Main","SK Düsseldorf","LK Offenbach","SK Köln","SK Wiesbaden")
